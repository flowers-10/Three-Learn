...
walles.geometry.setAttribute(
  "uv2",
  new THREE.Float32BufferAttribute(walles.geometry.attributes.uv.array, 2)
);
walles.position.y = 1.25;
walles.castShadow = true
house.add(walles);
// Roof
